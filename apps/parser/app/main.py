...
app = FastAPI(
    title="WASSCE Analytics Parser",
    description="PDF/XLSX parsing and university qualification engine for WASSCE results",
    version="0.1.0",
)
...
async def health_check():
    return {"status": "ok", "service": "wassce-parser"}
